        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="flex-1 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-xl">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/25 dark:border-white/10 bg-slate-950 shadow-[0_28px_80px_rgba(15,23,42,0.35)] aspect-[4/5] sm:aspect-[5/4]">
                <AnimatePresence mode="wait">
                  ...
                  >
                    {activeSlide.type === "image" ? (
                      <img alt={activeSlide.caption} className="h-full w-full object-contain" src={activeSlide.src} />
                    ) : (
                      <video
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                  <motion.p
                    ...
                    className="max-w-sm text-left text-xl font-semibold leading-snug text-white sm:text-2xl"
